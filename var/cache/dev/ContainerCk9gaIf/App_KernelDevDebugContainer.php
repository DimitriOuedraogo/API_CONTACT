...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'EventSubscriber'.\DIRECTORY_SEPARATOR.'ApiResponseSubscriber.php';
    ...
    {
        return $container->services['cache.security_is_csrf_token_valid_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('WjhcvYME1x', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->services['cache.security_is_granted_attribute_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('UhUdygfYUg', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('kernel.response', [#[\Closure(name: 'App\\EventSubscriber\\ApiResponseSubscriber')] fn () => ($container->privates['App\\EventSubscriber\\ApiResponseSubscriber'] ??= new \App\EventSubscriber\ApiResponseSubscriber()), 'onKernelResponse'], 10);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\ContactController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    /**
     * Gets the private '.service_locator.hw8_w66' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected static function get_ServiceLocator_Hw8W66Service($container)
    {
        return $container->privates['.service_locator.hw8_w66'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            ...
            'security.firewall.map.context.api_docs' => ['privates', 'security.firewall.map.context.api_docs', 'getSecurity_Firewall_Map_Context_ApiDocsService', true],
            ...
            'security.firewall.map.context.api_docs' => '?',
    ...
    {
        return $container->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+ILuNPstep', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XRtA0mN5J4', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['api_platform.cache.metadata.resource_collection'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NWDxNoEY0m', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ALu48zf8e0', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['logger'] ?? self::getLoggerService($container)));
    }
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_EventManagerService($container)
    {
        return $container->privates['doctrine.dbal.default_connection.event_manager'] = new \Symfony\Bridge\Doctrine\ContainerAwareEventManager(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'vich_uploader.listener.clean.contact_profile_images' => ['privates', 'vich_uploader.listener.clean.contact_profile_images', 'getVichUploader_Listener_Clean_ContactProfileImagesService', true],
            ...
            'vich_uploader.listener.remove.contact_profile_images' => ['privates', 'vich_uploader.listener.remove.contact_profile_images', 'getVichUploader_Listener_Remove_ContactProfileImagesService', true],
            'vich_uploader.listener.upload.contact_profile_images' => ['privates', 'vich_uploader.listener.upload.contact_profile_images', 'getVichUploader_Listener_Upload_ContactProfileImagesService', true],
        ], [
            'vich_uploader.listener.clean.contact_profile_images' => '?',
            ...
            'vich_uploader.listener.remove.contact_profile_images' => '?',
            'vich_uploader.listener.upload.contact_profile_images' => '?',
        ]), [[['preUpdate'], 'vich_uploader.listener.clean.contact_profile_images'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_dbal_cache_adapter_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.doctrine_token_provider_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.pdo_session_handler_schema_listener'], [['postGenerateSchema'], 'doctrine.orm.listeners.lock_store_schema_listener'], [['loadClassMetadata'], 'doctrine.orm.default_listeners.attach_entity_listeners'], [['preRemove'], 'vich_uploader.listener.remove.contact_profile_images'], [['postFlush'], 'vich_uploader.listener.remove.contact_profile_images'], [['prePersist'], 'vich_uploader.listener.upload.contact_profile_images'], [['preUpdate'], 'vich_uploader.listener.upload.contact_profile_images']]);
    }
    ...
    {
        $a = ($container->privates['.service_locator.hw8_w66'] ?? self::get_ServiceLocator_Hw8W66Service($container));
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.api_register' => ($container->privates['.security.request_matcher.c5Vdxqh'] ?? $container->load('get_Security_RequestMatcher_C5VdxqhService'));
            yield 'security.firewall.map.context.api_login' => ($container->privates['.security.request_matcher.Zj6oBoG'] ?? $container->load('get_Security_RequestMatcher_Zj6oBoGService'));
            yield 'security.firewall.map.context.api_docs' => ($container->privates['.security.request_matcher.I9Yc5UJ'] ?? $container->load('get_Security_RequestMatcher_I9Yc5UJService'));
    ...
    protected static function getSerializerService($container)
    {
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($m, $r, $h, $a, $s, NULL, $container->parameters['api_platform.serializer.default_context'], $a);
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'api_platform.title' => 'Contact API',
            'api_platform.description' => 'API for managing contacts',
            ...
            'vich_uploader.mappings' => [
                'contact_profile_images' => [
                    'uri_prefix' => '/uploads/contacts',
                    'upload_destination' => (\dirname(__DIR__, 4).'/public/uploads/contacts'),
                    'namer' => [
                        'service' => NULL,
                        'options' => NULL,
                    ],
