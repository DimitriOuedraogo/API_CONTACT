 ...
 */
class getVichUploader_Listener_Remove_ContactProfileImagesService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'vich_uploader.listener.remove.contact_profile_images' shared service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['vich_uploader.listener.remove.contact_profile_images'])) {
            return $container->privates['vich_uploader.listener.remove.contact_profile_images'];
        }

        return $container->privates['vich_uploader.listener.remove.contact_profile_images'] = new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('contact_profile_images', ($container->privates['vich_uploader.adapter.orm'] ??= new \Vich\UploaderBundle\Adapter\ORM\DoctrineORMAdapter()), ($container->privates['vich_uploader.metadata_reader'] ?? $container->load('getVichUploader_MetadataReaderService')), $a);
    }
}
